    ...
    <body>
        ...
        <div id="angel-container">
            ...
            <div id="angel-twitter-container">
                <a href="https://twitter.com/intent/tweet?text=I%20have%20${encodeURIComponent(angel.ascensions.toLocaleString())}%20points%20on%20New%20Chao%20Garden%20by%20%40doudou6351" target="_blank" style="display:inline-block;border:3px solid black;border-radius:10px;padding:10px 20px;background:white;color:black;text-decoration:none;font-size:20px;text-transform:uppercase;">Share on X</a>
            </div>
        </div>
        <div class="links">
            <a href="http://www.arcanekids.com/"><img class="grow" src="../client/img/arcanekids.png"></a>
